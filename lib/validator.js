...
var ConformaValidator = {
  ...
  number: function() {
    ...
    return function(field, value) {
      value += '';
      if(regex.test(value)) {
        return new _error.ConformaValidationError(field, 'only.numbers.allowed.in.value', value);
      }
    };
  },
  ...
  objectId: function() {
    ...
    return function(filed, value) {
      if(!checkForHexRegExp.test(value)) {
        return new _error.ConformaValidationError(filed, 'value.not.valid.object.id', value);
      }
    }
  }
};
